...
**Phase 5 - MP foundation** (done). **Phase 6 - MP correctness** (next: client prediction, snapshot interpolation, viewport culling tuning, lag compensation). See [docs/ROADMAP.md](docs/ROADMAP.md) for the 7-phase roadmap.
...
- [x] Phase 5 - MP foundation (protocol, Room DO, matchmaking, lobby, client WS) - shipped 2026-05-19
